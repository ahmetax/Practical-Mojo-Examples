...
def bearer_token_request(token: String) raises -> None:
    """
...
def api_key_request(api_key: String) raises-> None:
    """
...
def basic_auth_request(username: String, password: String) raises -> None:
    """
