...
def simple_download(url: String, save_path: String) raises -> None:
    """
...
def streaming_download(url: String, save_path: String, chunk_size: Int) raises -> None:
    """
...
def streaming_download_with_progress(url: String, save_path: String) raises -> None:
    """
